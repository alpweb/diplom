...
<body>
  <div class="wrapper">
        ...
        <div class="menu">
          <ul class="menu__list">              
            ...
            <li class="menu__item">
              ...
              <ul class="sub-menu__list">
                <li>
                  <a href="mashins.php" class="sub-menu__link">Пакувальні машини</ф>
                </li>
                <li>
                  <a href="lines.php" class="sub-menu__link">Автоматизовані лінії</a>
                </li>
                <li>
                  <span class="sub-menu__link active">Пакувальні машини - лінії</span>
                </li>
              </ul>
            </li>
            <li class="menu__item">
    ...
    <div class="main">
      <div class="container">
        <div class="main__row">
        <h1 class="title">Пакувальні машини - лінії</h1>
          <table>
            <tr>
